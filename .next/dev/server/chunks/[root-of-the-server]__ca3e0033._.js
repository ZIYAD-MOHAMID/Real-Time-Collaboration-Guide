...
const typeDefs = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$tag$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["gql"]`
  ...
  type Document {
    id: String!
    title: String!
    content: Bytes!    // REQUIRED for save to work
    type: String!
    createdAt: DateTime!
    updatedAt: DateTime!
    owner: User!
...
const resolvers = {
    Query: {
        documents: async ()=>{
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.findMany({
                include: {
                    owner: true,
                    access: {
                        include: {
        ...
        document: async (_, { id })=>{
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.findUnique({
                where: {
                    id
                },
                include: {
    ...
    Mutation: {
        ...
        updateDocument: async (_, { id, title, content }, context)=>{
            ...
            if (!context?.user) {
                ...
                const defaultUserId = "cmk1q6rlz00005m8ivwcxc5cy"; // Your user ID
                const document = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.update({
                    where: {
                        id
                    },
                    data: {
        ...
        deleteDocument: async (_, { id }, context)=>{
            ...
            if (!context?.user) {
                ...
                const document = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.findUnique({
                    where: {
                        id
                    }
                });
        ...
        shareDocument: async (_, { documentId, userId, permission }, context)=>{
            ...
            if (!context?.user) {
                ...
                if (userId.includes("@")) {
                    ...
                    const targetUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.upsert({
                        where: {
                            email
                        },
                        update: {},
                ...
                const access = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].documentAccess.upsert({
                    where: {
                        userId_documentId: {
                            userId: storedUserId,
                            documentId
        ...
        revokeAccess: async (_, { documentId, userId }, context)=>{
            ...
            if (!context?.user) {
                ...
                let storedUserId = userId;
                if (userId.includes("@")) {
                    const targetUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
                        where: {
                            email: userId
                        }
                    });
                ...
                try {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].documentAccess.delete({
                        where: {
                            userId_documentId: {
                                // Correct field name
                                userId: storedUserId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ca3e0033._.js.map